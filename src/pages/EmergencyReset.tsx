...
export default function EmergencyReset() {
  ...
  const handleReset = async () => {
    ...
    try {
      const response = await fetch('https://functions.poehali.dev/743e5e24-86d0-4a6a-90ac-c71d80a5b822?action=emergency_reset', {
        method: 'POST',
  ...
  const handleTest = async () => {
    ...
    try {
      const response = await fetch('https://functions.poehali.dev/743e5e24-86d0-4a6a-90ac-c71d80a5b822?action=test', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
